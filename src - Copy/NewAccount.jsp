							...
							<tr>
								<td>
									<div class="input">
										...
										<input type="text" class="input-field" name="amount" id="amount" value="12000"
											required />
									</div>
								</td>
								<td>
									<div class="input">
										...
										<input type="text" class="input-field" name="phone" id="phone"
											value="9087890876" maxlength="10" required />
									</div>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<div class="input">
										...
										<input type="date" class="input-field" name="DOB" id="DOB" value="02-05-1998"
											required />
									</div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="input">
										...
										<input type="text" class="input-field" name="area" id="area" value="Begumpet" />
									</div>
								</td>
								<td>
									<div class="input">
										<label class="input-label">City</label>
										<input type="text" class="input-field" name="city" id="city" value="Hyd" />
									</div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="input">
										...
										<input type="text" class="input-field" name="state" id="state" value="TS" />
									</div>
								</td>
								<td>
									<div class="input">
										<label class="input-label">ZIP</label>
										<input type="text" class="input-field" name="zip" id="zip" value="500013"
											maxlength="6" />
									</div>
								</td>
							</tr>
								...
								<td>
									<div class="input">
										...
										<input type="password" class="input-field" name="password" id="password"
											maxlength="10" value="Divya123" required />
									</div>
								</td>
								<td>
									<div class="input">
										<label class="input-label">Confirm Password</label>
										<input type="password" class="input-field" name="repassword" id="repassword"
											maxlength="10" value="Divya123" required />
									</div>
								</td>
							</tr>
